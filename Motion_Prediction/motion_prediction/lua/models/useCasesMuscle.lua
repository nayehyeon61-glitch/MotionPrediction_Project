...
--require("IPC_based/useCase_turn2") useCase=useCases.turn 
--require("useCase_turn2") useCase=useCases.turn 

--require("useCaseMuscle_fullbody_tong") useCase=useCases.fullbody_tong

--require("useCaseMuscle_gait1956_6steps") useCase=useCases.gait1956_6steps
--require("useCaseMuscle_gait1956_tong") useCase=useCases.gait1956_tong

--require("useCaseMuscle_gait1992_6steps") useCase=useCases.gait1992_6steps
--require("useCaseMuscle_gait1992_tong") useCase=useCases.gait1992_tong


-----------------
--VIDEO
	--various motion, model

	-- mscl 4x
	--require("useCaseMuscle_full_ipnrun_repeat")           useCase=useCases.full_ipnrun_repeat

	---- mscl 4x
	--require("useCaseMuscle_full_tong_repeat")           useCase=useCases.full_tong_repeat

	---- mscl 4x
	--require("useCaseMuscle_full_ipfrun_repeat")           useCase=useCases.full_ipfrun_repeat

	-- walking
	--require("useCaseMuscle_full_lean_repeat")        useCase=useCases.full_lean_repeat

	-- walking
	--require("useCaseMuscle_gait1992_gait_repeat")       useCase=useCases.gait1992_gait_repeat

	-- walking
	--require("useCaseMuscle_gait1992_soldier_repeat")    useCase=useCases.gait1992_soldier_repeat

	---- mscl 4x
	--require("useCaseMuscle_gait1992_tong_repeat")       useCase=useCases.gait1992_tong_repeat

	---- walking
	--require("useCaseMuscle_gait1956_gait_repeat")       useCase=useCases.gait1956_gait_repeat

	---- mscl 4x
	--require("useCaseMuscle_gait1956_tong_repeat")       useCase=useCases.gait1956_tong_repeat

	-----------------
	--changes on muscle scale
...
----effortdist modifysim, no
--require("useCaseMuscle_gait1956_soldier_repeat")    useCase=useCases.gait1956_soldier_repeat
...
--NOT USED
--require("useCaseMuscle_full_sit_repeat")        useCase=useCases.full_sit_repeat
--require("useCaseMuscle_full_sukiko_repeat")         useCase=useCases.full_sukiko_repeat
--require("useCaseMuscle_full_same_repeat")        useCase=useCases.full_same_repeat
--require("useCaseMuscle_full_soldier_repeat")        useCase=useCases.full_soldier_repeat

---- adaptation
----require("useCaseMuscle_gait1956_adapt_tong_repeat") useCase=useCases.gait1956_adapt_tong_repeat
----require("useCaseMuscle_full_adapt_tong_repeat")           useCase=useCases.full_adapt_tong_repeat
