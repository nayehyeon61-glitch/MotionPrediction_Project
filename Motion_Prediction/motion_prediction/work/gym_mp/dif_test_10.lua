...
function ctor()
	...
	tempBuffer = matrixn(2,encode_size)
	temp_Buffer_for_saving=matrixn(2,encode_size)
...
function frameMove(fElapsedTime)
	...
	if iframe < 2 then
		...
		pushBack(tempBuffer,poseEncodeUpdate(iframe))
		...
		python.F('play_mp','noise_data',latent,encodeBuffer:row(1),tempBuffer)
		--python.F('play_mp','test_dif3',latent,encodeBuffer:row(1),encodeData)
		python.F('play_mp','test_dif3',tempBuffer:row(0),ebcodeBuffer:row(1),encodeData)
		pushBack(tempBuffer,encodeData)
