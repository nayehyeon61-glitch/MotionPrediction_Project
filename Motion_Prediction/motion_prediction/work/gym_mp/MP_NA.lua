		...
		for i=1,model_config.prediction_frame  do 
			...
			-- run model
			  ...
			  --python.F('train_motionprediction_dif16','test_dif16',inputBuffer:row(0),inputBuffer:row(0),latent,encodeData)
                ...
                python.F('train_motionprediction_dif_multi','test_dif316',inputBuffer:row(0),inputBuffer:row(1),inputBuffer:row(2),inputBuffer:row(3),inputBuffer:row(4),inputBuffer:row(5),inputBuffer:row(6),inputBuffer:row(7),inputBuffer:row(8),inputBuffer:row(9),latent,encodeData)
